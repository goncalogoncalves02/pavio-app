  ...
  return (
    <section className="contact-section" id="contactos" aria-labelledby="contact-title">
      ...
      <div className="contact-inner" data-reveal>
        ...
        <p>Esteja em {siteConfig.serviceArea} ou noutra zona de {siteContent.business.shippingArea}, conte-nos a ocasião, o ambiente ou a pessoa que tem em mente. Respondemos com disponibilidade e um orçamento à medida.</p>
