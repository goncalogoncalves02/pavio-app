  ...
  return new ImageResponse(
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", width: "720px" }}>
        <div style={{ fontFamily: "Arial, sans-serif", fontSize: 20, letterSpacing: 5, textTransform: "uppercase", color: "#a98a5b" }}>
      ...
      <div style={{ width: 250, height: 380, display: "flex", alignItems: "flex-end", justifyContent: "center", borderRadius: "140px 140px 28px 28px", background: "#e7dcc8", boxShadow: "0 28px 60px rgba(58, 42, 30, .18)" }}>
        <div style={{ display: "flex", width: 118, height: 250, borderRadius: "56px 56px 20px 20px", background: "#f8f2e6", alignItems: "flex-start", justifyContent: "center" }}>
          <div style={{ width: 32, height: 50, marginTop: -46, borderRadius: "65% 35% 62% 38%", background: "#9a4a2c", transform: "rotate(12deg)" }} />
        </div>
      </div>
    </div>,
    size,
